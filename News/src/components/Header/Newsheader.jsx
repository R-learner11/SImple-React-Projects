  ...
  return (
    ...
    <div className='sticky w-full bg-[#222222] h-77px '>
        <div className='pl-3 sm:pl-[20px] lg:pl-[30px] pt-[10px] pb-[8px]'>
            <div className='font-bold text-[32px] leading-9 flex justify-between'>
                <p className='text-white'>{header}</p>
                <select 
                className='sm:w-[100px] w-[20px]  h-[30px]  text-xs mr-3 md:mr-[30px] mt-2 font-extralight rounded-lg'
                name="" id="">
            ...
            <svg
                ...
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#FFFFFF" className=" lg:hidden w-8 h-8"
                >
                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                </svg>
            </div>

            <div className={`text-white ${isOpen?'':'hidden'} lg:flex mt-2 lg:sticky items-center w-full font-extralight text-[14px] lg:w-auto lg:order-1`}>
